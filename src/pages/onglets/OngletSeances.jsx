...
import { TYPES_SEANCE } from '../../lib/constantes'
            ...
            <div key={seance.id} className="element">
              ...
              <div className="corps">
                <div className="titre">
                  ...
                  {seance.duree_min ? <span className="doux"> · {seance.duree_min} min</span> : null}
                </div>
                <div className="meta">
  ...
  return (
    <Feuille titre="Nouvelle séance" ouverte={ouverte} onFermer={onFermer}>
      <form onSubmit={enregistrer}>
        ...
        <Champ label="Notes" aide="Visible par tous les cavaliers du cheval">
          <textarea
            value={valeurs.notes}
            onChange={modifier('notes')}
            placeholder="Comment s'est passée la séance, points à travailler…"
          />
        </Champ>
